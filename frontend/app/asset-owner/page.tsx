...
export default function AssetOwnerPage() {
  ...
  const t = useTranslations("assetOwner");

  return (
    <div className="animate-fade-in">
      {/* Page heading */}
      <div className="mb-8">
        <h1 className="text-2xl font-semibold text-foreground">{t("overview")}</h1>
        <p className="text-sm text-gray-500 mt-1">{t("welcomeDesc")}</p>
      </div>
